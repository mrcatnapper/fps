...
BOOST_AUTO_TEST_CASE(parses_and_formats_canonical_v4_uuid) {
  ...
  BOOST_TEST(fps::format_client_uuid(parsed.value()) ==
...
BOOST_AUTO_TEST_CASE(derives_deterministic_x25519_keypair_from_uuid) {
  auto first = fps::derive_client_key_pair_from_uuid(
      "123e4567-e89b-42d3-a456-426614174000");
  auto second = fps::derive_client_key_pair_from_uuid(
      "123e4567-e89b-42d3-a456-426614174000");
  ...
  BOOST_TEST(hex(first.value().private_key) ==
             "8030d0bcd1bed66712ac8dcf0a667ba019ee7e1da73d953ed0e04a5142370356");
  BOOST_TEST(hex(first.value().public_key) ==
             "b136e8c9eb5b956324915fc42edee8b03800cf1a2d6c84015380b4ddd72f062c");
}
