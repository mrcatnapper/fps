...
BOOST_AUTO_TEST_CASE(appends_unsigned_integers_in_network_byte_order) {
    ...
    const std::array expected{
        std::byte{0x12}, std::byte{0x34}, std::byte{0x56}, std::byte{0x78}, std::byte{0x9a}, std::byte{0xbc}, std::byte{0xde},
        std::byte{0xf0}, std::byte{0x01}, std::byte{0x23}, std::byte{0x45}, std::byte{0x67}, std::byte{0x89}, std::byte{0xab},
    };
...
BOOST_AUTO_TEST_CASE(reads_unsigned_integers_from_offsets) {
    const std::array bytes{
        std::byte{0xff}, std::byte{0x12}, std::byte{0x34}, std::byte{0x56}, std::byte{0x78}, std::byte{0x9a}, std::byte{0xbc}, std::byte{0xde},
        std::byte{0xf0}, std::byte{0x01}, std::byte{0x23}, std::byte{0x45}, std::byte{0x67}, std::byte{0x89}, std::byte{0xab},
    };
