...
внутри несёт зашифрованный пакет FPS с TUN-кадрами, управляющими сообщениями и
паддингом. Реальные TLS-записи браузера/сервера остаются в том же упорядоченном
TCP-потоке и не терминируются FPS.
