...
class TestVpnHarnessActivity : Activity() {
    ...
    private fun onPrepared() {
        ...
        val serviceAction = when (intent.action) {
            ...
            ACTION_COORDINATED_PRODUCT_FLOW_STORED -> TestVpnEstablishService.ACTION_COORDINATED_PRODUCT_FLOW_START
            else -> null
        }
    ...
    companion object {
        ...
        const val ACTION_COORDINATED_PRODUCT_FLOW_STORED = "org.fpsproject.client.test.action.COORDINATED_PRODUCT_FLOW_STORED"
