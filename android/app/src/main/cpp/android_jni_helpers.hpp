...
[[nodiscard]] auto tun_policy_packet_array(JNIEnv* env, const std::vector<fps::android_native::NativeTunPolicyPacketFields>& packets) -> jobjectArray;
[[nodiscard]] auto native_event_array(JNIEnv* env, const std::vector<fps::android_native::NativeRuntimeEventFields>& events) -> jobjectArray;
